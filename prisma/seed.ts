    ...
    itinerary: [
      {
        ...
        description:
          "Arrive at Balekambang Beach, explore the white sandy beach.",
      },
      {
        time: "16:30",
        title: "Visit Pura Ismoyo",
        description:
          "Walk across the bridge to the Pura Ismoyo on the rock island.",
      },
      {
        time: "17:30",
        title: "Sunset Session",
        description:
          "Capture the breathtaking sunset with the temple silhouette.",
      },
    ],
    openTime: "24 Hours",
    ticketPrice: "Rp 20.000",
    facilities: ["Parking", "Toilet", "Warung", "Mushola"],
  },
  {
    name: "Gunung Bromo",
    category: "Gunung",
    ...
    itinerary: [
      ...
      },
      {
        ...
        description:
          "Witness the magical sunrise over Mt. Bromo and Mt. Semeru.",
      },
      {
        time: "06:00",
    ...
    openTime: "24 Hours",
    ticketPrice: "Rp 220.000 (WNA Rp 320.000)",
    facilities: ["Jeep Rental", "Horse Riding", "Warung", "Toilet"],
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1555899436-72534f6f4299?auto=format&fit=crop&q=80&w=800",
    ...
    facilities: ["Parking", "Toilet", "Souvenir Shop"],
  },
  {
    name: "Teluk Asmara",
    category: "Pantai",
    ...
    facilities: ["Parking", "Toilet", "Camping Ground", "Warung"],
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1582913130094-0cf594d76f8e?auto=format&fit=crop&q=80&w=800",
      "https://images.unsplash.com/photo-1596401057633-56565377f06d?auto=format&fit=crop&q=80&w=800",
    ],
    highlights: [
    ...
    itinerary: [
      {
        ...
        title: "Evening Walk",
        description:
          "Stroll along the heritage street under the classic lamps.",
      },
      {
        time: "20:00",
        title: "Coffee Time",
    ...
    openTime: "24 Hours",
    ticketPrice: "Free",
    facilities: ["Cafe", "Photo Spots", "Benches"],
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1518709414768-a88986a45d5a?auto=format&fit=crop&q=80&w=800",
      "https://images.unsplash.com/photo-1546702755-22d76588b945?auto=format&fit=crop&q=80&w=800",
    ],
    highlights: [
    ...
    facilities: ["Parking", "Toilet", "Souvenir Shop", "Outbound Area"],
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1542385151-efd9000e8bc5?auto=format&fit=crop&q=80&w=800",
      "https://images.unsplash.com/photo-1577002540984-7a250320eeab?auto=format&fit=crop&q=80&w=800",
    ],
    highlights: [
    ...
    ticketPrice: "Rp 55.000 (Regular)",
    facilities: ["Food Court", "Toilet", "Parking", "Mushola"],
  },
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1519046904884-53103b34b271?auto=format&fit=crop&q=80&w=800",
    ],
    highlights: [
    ...
    itinerary: [
      {
        ...
        title: "Check Point",
        description:
          "Bag check at conservation post (no plastic trash allowed).",
      },
      {
        time: "09:00",
        title: "Trek to Beach",
    ...
    ticketPrice: "Rp 10.000 + Guide Rp 150.000",
    facilities: ["Guide", "Snorkeling Gear", "Toilet", "Gazebo"],
  },
];
  ...
  for (const dest of destinations) {
    const d = await prisma.destination.create({
      data: {
        ...
        images: JSON.stringify(dest.images),
        highlights: JSON.stringify(dest.highlights),
        itinerary: JSON.stringify(dest.itinerary), // Added Itinerary
        facilities: JSON.stringify(dest.facilities),
        openTime: dest.openTime,
        ticketPrice: dest.ticketPrice,
      },
    });
    console.log(`Created destination with id: ${d.id}`);
  }
